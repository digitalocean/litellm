...
def test_responses_api_bridge_check_gpt_5_6_tools_without_reasoning_routes_to_responses(
    ...
    """gpt-5.6+ with tools only (no reasoning_effort) must bridge to Responses API."""
    from litellm.main import responses_api_bridge_check
...
def test_responses_api_bridge_check_gpt_5_6_tools_plus_reasoning_routes_to_responses():
    """gpt-5.6 with tools + reasoning_effort should still route to Responses API."""
    from litellm.main import responses_api_bridge_check
...
@pytest.mark.parametrize("model_name", ["gpt-5.4", "gpt-5.5", "gpt-5.5-pro"])
def test_responses_api_bridge_check_gpt_5_4_and_5_5_tools_without_reasoning_stay_chat(
    model_name,
):
    """gpt-5.4/5.5 tools-only (no reasoning_effort) must stay on chat completions."""
    from litellm.main import responses_api_bridge_check
