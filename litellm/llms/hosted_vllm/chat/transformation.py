...
class HostedVLLMChatConfig(OpenAIGPTConfig):
    ...
    def map_openai_params(
        ...
        if _tools is not None:
            # Strip additionalProperties:false for older OpenAI-compatible
            # backends, but preserve tools[].function.strict. Modern vLLM uses
            # strict:true under tool_choice=auto for schema-constrained tool
            # arguments (see BerriAI/litellm#6088 vs current vLLM tool calling).
